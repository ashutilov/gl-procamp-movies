...
export function saveMovie(data) {
  return dispatch => {
    return fetch('https://dev.lxhub.org/api/movies', {
      method: 'post',
...
export  function fetchMovies() {
  return dispatch => {
    fetch('https://dev.lxhub.org/api/movies')
    .then(handleResponse)
...
export function updateMovie(data) {
  return dispatch => {
    fetch(`https://dev.lxhub.org/api/movies/${data.id}`, {
      method: 'put',
      body: JSON.stringify(data),
      headers: {
        'Content-Type': 'application/json'
...
export function deleteMovie(id) {
  return dispatch => {
    fetch(`https://dev.lxhub.org/api/movies/${id}`, {
      method: 'delete',
      headers: {
        'Content-Type': 'application/json'
      }
